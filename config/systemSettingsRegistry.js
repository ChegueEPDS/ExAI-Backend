...
const SETTINGS = [
  ...
  { key: 'TABLE_PROFILE_ENABLED', group: 'Table profile', type: 'boolean', defaultValue: true, description: 'Enable table_profile tool for data quality/outlier/missing analysis.' },
  { key: 'TABLE_PROFILE_MAX_FILES', group: 'Table profile', type: 'number', defaultValue: 3, description: 'Max XLSX files profiled per question.' },
  { key: 'TABLE_PROFILE_MAX_ROWS', group: 'Table profile', type: 'number', defaultValue: 12000, description: 'Max rows scanned per file for profiling.' },
  { key: 'TABLE_PROFILE_MAX_COLS', group: 'Table profile', type: 'number', defaultValue: 80, description: 'Max columns profiled per file.' },
  { key: 'TABLE_COMPARE_ENABLED', group: 'Table compare', type: 'boolean', defaultValue: true, description: 'Enable table_compare tool for generic sheet/file comparisons.' },
  { key: 'TABLE_COMPARE_MAX_FILES', group: 'Table compare', type: 'number', defaultValue: 2, description: 'Max XLSX files compared per question.' },
  { key: 'TABLE_COMPARE_MAX_ROWS', group: 'Table compare', type: 'number', defaultValue: 12000, description: 'Max rows scanned per file for compare.' },
  { key: 'TABLE_COMPARE_MAX_COLS', group: 'Table compare', type: 'number', defaultValue: 80, description: 'Max columns scanned per file for compare.' },
  { key: 'TABLE_PIVOT_ENABLED', group: 'Table pivot', type: 'boolean', defaultValue: true, description: 'Enable table_pivot tool for grouped summaries.' },
  { key: 'TABLE_PIVOT_MAX_FILES', group: 'Table pivot', type: 'number', defaultValue: 3, description: 'Max XLSX files scanned for table_pivot.' },
  { key: 'TABLE_PIVOT_MAX_ROWS', group: 'Table pivot', type: 'number', defaultValue: 12000, description: 'Max rows scanned per file for pivot.' },
  { key: 'TABLE_PIVOT_MAX_COLS', group: 'Table pivot', type: 'number', defaultValue: 80, description: 'Max columns scanned per file for pivot.' },
  { key: 'TIME_SERIES_ENABLED', group: 'Time series', type: 'boolean', defaultValue: true, description: 'Enable time_series tool for resample + trend.' },
  { key: 'TIME_SERIES_MAX_FILES', group: 'Time series', type: 'number', defaultValue: 2, description: 'Max XLSX files scanned for time_series.' },
  { key: 'TIME_SERIES_MAX_ROWS', group: 'Time series', type: 'number', defaultValue: 12000, description: 'Max rows scanned per file for time_series.' },
  { key: 'TIME_SERIES_MAX_COLS', group: 'Time series', type: 'number', defaultValue: 80, description: 'Max columns scanned per file for time_series.' },
  { key: 'COMPLIANCE_CHECK_ENABLED', group: 'Compliance check', type: 'boolean', defaultValue: true, description: 'Enable compliance_check tool for requirements list + compliance matrix.' },
  { key: 'COMPLIANCE_CHECK_MODEL', group: 'Compliance check', type: 'string', defaultValue: 'gpt-5-mini', description: 'Model for compliance_check.' },
  { key: 'COMPLIANCE_CHECK_MAX_STANDARDS', group: 'Compliance check', type: 'number', defaultValue: 12, description: 'Max standards clauses passed to compliance_check.' },
  { key: 'COMPLIANCE_CHECK_MAX_DOCS', group: 'Compliance check', type: 'number', defaultValue: 12, description: 'Max document chunks passed to compliance_check.' },
  { key: 'COMPLIANCE_CHECK_MAX_TABLES', group: 'Compliance check', type: 'number', defaultValue: 18, description: 'Max table rows passed to compliance_check.' },
  { key: 'COMPLIANCE_CHECK_MAX_CHARS', group: 'Compliance check', type: 'number', defaultValue: 1200, description: 'Max chars per item passed to compliance_check.' },
